...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(int p0, int p1, out int p2, out int p3, out int p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp12(ref int p0, ref int p1, out int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(XLuaSys.HeroDelegate))
			{
			    return new XLuaSys.HeroDelegate(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(CSharpCallLua.delAddingMutilReturnOut))
			{
			    return new CSharpCallLua.delAddingMutilReturnOut(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(CSharpCallLua.delAddingMutilReturnRef))
			{
			    return new CSharpCallLua.delAddingMutilReturnRef(__Gen_Delegate_Imp12);
			}
