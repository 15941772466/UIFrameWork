...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(XLuaSys.Hero), XLuaSysHeroWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XLuaSys.GenericBySelf), XLuaSysGenericBySelfWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XLuaSys.Extension_GenericBySelf), XLuaSysExtension_GenericBySelfWrap.__Register);
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(XLuaSys.HeroInterface), XLuaSysHeroInterfaceBridge.__Create);
            
            translator.AddInterfaceBridgeCreator(typeof(CSharpCallLua.GameNames), CSharpCallLuaGameNamesBridge.__Create);
